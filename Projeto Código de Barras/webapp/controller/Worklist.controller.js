sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend('z549.buscaproduto.controller.Worklist', {
      formatter: formatter,
      ...
      onCameraBarcodeScan: function () {
        return new Promise((resolve, reject) => {
          BarcodeScanner.scan(function (mResult) {
            ...
            if (
              mResult.cancelled == false &&
              (mResult.text == '' || mResult.text == undefined)
            ) {
