		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#z549buscaproduto-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z549buscaproduto-display": {
								"semanticObject": "z549buscaproduto",
								"action": "display",
								"description": "Relatório de Produto",
								"title": "Relatório de Produto",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z549.buscaproduto",
									"url": sap.ui.require.toUrl("z549/buscaproduto")
								}
							}
						}
					}
