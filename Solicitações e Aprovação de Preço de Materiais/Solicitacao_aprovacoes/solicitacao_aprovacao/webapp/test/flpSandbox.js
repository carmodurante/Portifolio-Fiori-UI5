		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ação Urgente",
									"targetURL": "#carmo5495psolicitacaoaprovacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"carmo5495psolicitacaoaprovacao-display": {
								"semanticObject": "carmo5495psolicitacaoaprovacao",
								"action": "display",
								"description": "Solicitações de Aprovação",
								"title": "Ação Urgente",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=carmo5495p.solicitacaoaprovacao",
									"url": sap.ui.require.toUrl("carmo5495p/solicitacaoaprovacao")
								}
							}
						}
					}
